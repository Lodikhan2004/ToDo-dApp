...
namespace AElf.Contracts.ToDo
{
    ...
    {
        const string author ="1RN22CS078";
        public override Empty Initialize(Empty input) //behaves like constructor
        {
        ...
        public override StringValue CreateTask(TaskInput input)  //help in creating a task
        {
            if (!State.Initialized.Value)
            {
        ...
        public override Empty UpdateTask(TaskUpdateInput input) //we can update a task
        {
        ...
        public override Task GetTask(StringValue input) //get the details of task
        {
